-- =====================================================
-- FASE 1: CREAR TABLAS MYSQL FALTANTES
...
-- Producciones
-- Producción 1: Lechuga Latina en Rancho Los Andes
INSERT INTO `producciones` (`folio`, `articulo_id`, `fecha`, `hora`, `usuario`, `estatus`, `aplicado`, `cantidad`, `centro_costo_id`, `monitoring`)
VALUES ('CSJ2601-17-A', 1, '2026-06-03', '08:30:00', 'admin', 'N', 'S', 2.50, 1, 1);

-- Producción 2: Tomate Cherry en Rancho San Miguel
INSERT INTO `producciones` (`folio`, `articulo_id`, `fecha`, `hora`, `usuario`, `estatus`, `aplicado`, `cantidad`, `centro_costo_id`, `monitoring`)
VALUES ('CSJ2602-24', 2, '2026-06-10', '09:00:00', 'admin', 'N', 'S', 3.75, 2, 1);

-- Producción 3: Pepino en Rancho El Peñol
INSERT INTO `producciones` (`folio`, `articulo_id`, `fecha`, `hora`, `usuario`, `estatus`, `aplicado`, `cantidad`, `centro_costo_id`, `monitoring`)
VALUES ('CSJ2603-31', 3, '2026-06-15', '07:45:00', 'admin', 'N', 'S', 4.20, 3, 1);

-- Producción 4: Cilantro en Rancho Los Andes (sin monitoreo)
INSERT INTO `producciones` (`folio`, `articulo_id`, `fecha`, `hora`, `usuario`, `estatus`, `aplicado`, `cantidad`, `centro_costo_id`, `monitoring`)
VALUES ('CSJ2604-45', 4, '2026-07-01', '08:15:00', 'admin', 'N', 'S', 1.80, 1, 0);

-- Producción 5: Espinaca en Rancho La Esperanza
INSERT INTO `producciones` (`folio`, `articulo_id`, `fecha`, `hora`, `usuario`, `estatus`, `aplicado`, `cantidad`, `centro_costo_id`, `monitoring`)
VALUES ('CSJ2605-52', 5, '2026-07-05', '09:30:00', 'admin', 'N', 'S', 2.10, 4, 1);

-- Zonas de Producción - Rancho Los Andes
...
-- Producción 1 (Lechuga) asignada a Zona Norte Los Andes
INSERT INTO `asignaciones_zonas_producciones` (`produccion_id`, `zona_produccion_id`, `tipo_asignacion`, `area`, `poligono`)
VALUES (1, 1, 'P', 2.50, '[[21.10535, -100.93089], [21.10535, -100.92730], [21.1068, -100.92730], [21.1068, -100.93089]]');

-- Producción 2 (Tomate) asignada a Zona Este San Miguel
INSERT INTO `asignaciones_zonas_producciones` (`produccion_id`, `zona_produccion_id`, `tipo_asignacion`, `area`, `poligono`)
VALUES (2, 3, 'P', 3.75, '[[21.11000, -100.94000], [21.11000, -100.93500], [21.11300, -100.93500], [21.11300, -100.94000]]');

-- Producción 3 (Pepino) asignada a Zona Central El Peñol
INSERT INTO `asignaciones_zonas_producciones` (`produccion_id`, `zona_produccion_id`, `tipo_asignacion`, `area`, `poligono`)
VALUES (3, 4, 'T', 4.20, '[[21.10800, -100.92000], [21.10800, -100.91500], [21.11100, -100.91500], [21.11100, -100.92000]]');

-- Producción 4 (Cilantro) asignada a Zona Sur Los Andes
INSERT INTO `asignaciones_zonas_producciones` (`produccion_id`, `zona_produccion_id`, `tipo_asignacion`, `area`, `poligono`)
VALUES (4, 2, 'P', 1.80, '[[21.10200, -100.93000], [21.10200, -100.92500], [21.10500, -100.92500], [21.10500, -100.93000]]');

-- Producción 5 (Espinaca) asignada a Zona Norte Los Andes
INSERT INTO `asignaciones_zonas_producciones` (`produccion_id`, `zona_produccion_id`, `tipo_asignacion`, `area`, `poligono`)
VALUES (5, 1, 'P', 2.10, '[[21.10580, -100.93050], [21.10580, -100.92800], [21.10650, -100.92800], [21.10650, -100.93050]]');

-- =====================================================
-- VERIFICAR DATOS INSERTADOS
-- =====================================================
SELECT 'Artículos creados:' as info;
SELECT * FROM articulos;

SELECT 'Centros de Costo creados:' as info;
SELECT * FROM centros_costos;

SELECT 'Producciones creadas:' as info;
SELECT p.*, a.nombre as cultivo, c.nombre as rancho
FROM producciones p
JOIN articulos a ON p.articulo_id = a.articulo_id
JOIN centros_costos c ON p.centro_costo_id = c.centro_costo_id;

SELECT 'Zonas de Producción creadas:' as info;
SELECT * FROM zonas_producciones;

SELECT 'Asignaciones de Zonas a Producciones:' as info;
SELECT az.*, p.folio, z.nombre as zona_nombre
FROM asignaciones_zonas_producciones az
JOIN producciones p ON az.produccion_id = p.produccion_id
JOIN zonas_producciones z ON az.zona_produccion_id = z.zona_produccion_id;
